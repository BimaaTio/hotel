...
$id = $_SESSION['uid'];
$data = query("SELECT * FROM tb_user WHERE uid = $id ")[0];
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>BM Hotel &mdash; <?= ucwords($title) ?></title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">BM Hotel</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Data Hotel</h6>
                        <a class="collapse-item" href="?hal=kamar">Kelola Kamar</a>
                        <a class="collapse-item" href="?hal=fasilitas">Kelola Fasilitas</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Data Akun</h6>
                        <a class="collapse-item" href="?hal=user">Kelola User</a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                ...
                <div id="pengaturan" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Pengaturan</h6>
                        <a class="collapse-item" href="?hal=profil">Pengaturan Akun</a>
                        <a class="collapse-item" href="?hal=pengaturan">Pengaturan Website</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span
                                    class="mr-2 d-none d-lg-inline text-gray-600 small"><?= ucwords($data['uname']) ?></span>
                ...
                <div class="container-fluid">
                    ...
                    if(isset($_GET['hal'])){
                        ...
                        echo
                        "<script>document.location.href=?hal=''</script>";
                    }
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; BM Hotel 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
